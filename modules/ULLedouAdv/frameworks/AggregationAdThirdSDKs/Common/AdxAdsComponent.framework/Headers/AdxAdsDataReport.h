...
-(void) reportThirdPlatformInit;

- (void)reportAggregationSDKStartCache;

- (void)reportAggregationSDKCacheSuccess;
...
-(void) reportAggregationSDKStartShow:(NSString*)blockid;
...
- (void)reportThirdPlatformInit:(NSString*)blockid;

- (void)reportAggregationSDKStartCache:(NSString*)blockid;

- (void)reportAggregationSDKCacheSuccess:(NSString*)blockid;
