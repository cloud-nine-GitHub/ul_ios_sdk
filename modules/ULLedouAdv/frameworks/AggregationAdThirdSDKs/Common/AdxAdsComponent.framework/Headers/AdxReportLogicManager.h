...
extern NSString* const ADXAD_REPORT_HTML_CLOSE;

extern NSString* const ADXAD_REPORT_THIRD_PLATFORM_INIT;

extern NSString* const ADXAD_REPORT_AGGREGATION_SDK_START_CACHE;
extern NSString* const ADXAD_REPORT_AGGREGATION_SDK_CACHE_SUCCESS;
extern NSString* const ADXAD_REPORT_AGGREGATION_SDK_START_SHOW;
