...
@interface MCULDemo ()<UITextFieldDelegate>
...
- (void)addListener
{
    [[ULNotificationDispatcher getInstance] addNotificationWithObserver:self withName:UL_NOTIFICATION_MC_OPEN_DEMO_PAY_CALLBACK withSelector:@selector(payCallback:) withPriority:-1];
}
...
- (void)payLabelClick
{
    ...
    [[ULNotificationDispatcher getInstance] postNotificationWithName:UL_NOTIFICATION_MC_OPEN_DEMO_PAY withData:[self getModulePayTestData:_payId]];
}
