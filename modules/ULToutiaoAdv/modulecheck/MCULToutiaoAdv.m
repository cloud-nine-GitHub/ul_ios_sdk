...
- (void)addListener
{
    [[ULNotificationDispatcher getInstance] addNotificationWithObserver:self withName:UL_NOTIFICATION_MC_SHOW_TOUTIAO_ADV_CALLBACK withSelector:@selector(advCallback:) withPriority:-1];
}
